...
<html lang="zxx">
  ...
  <head>
    ...
    <title>Relax Cream Relaxer | Cospharma Limited</title>
    <!-- google fonts -->
...
<script>
  ...
  <!-- //about breadcrumb -->
   <!--/contact-->
    ...
    <div class="container py-md-5">
        <div class="row">
                <div class="col-md-6">
                    <img src="acms/upload/<?php echo $rows['image_1'];?>" class="img-fluid" alt="">
                </div>
            <div class="col-md-6">
            <img src="acms/upload/<?php echo $rows['image_2'];?>" class="img-fluid" alt="">
            </div>
        </div>
    </div>
  </section>
  ...
  <div class="row">
              ...
              <h3><?php echo $rows['product_name'];?></h3>
                <p class="my-3 pr-lg-4"><?php echo $rows['content'];?> <br>
