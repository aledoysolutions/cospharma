                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Edit <code>  Page</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         ...
                                         <form action="proc_edit_pages.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="title" type="text"   value="<?php echo $row['title'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Banner Image<br><img src="upload/<?php echo $row['banner_image'] ;?>" style="width: 50px;"></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="banner_image" type="file"  value="<?php echo $banner_image ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Video Url<br><img src="upload/<?php echo $row['video_url'] ;?>" style="width: 50px;"></label>
                                        <div class="col-md-12 border-bottom p-0">
