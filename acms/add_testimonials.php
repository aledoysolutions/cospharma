                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Please fill the form below to add a <code>  Testimonial</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         <tr>
                                         <form action="proc_add_testimonials.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="title" type="text"  style="width: 150px;" value="<?php echo $title ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Content</label>
                                        <div class="col-md-12 border-bottom p-0">
                                        <textarea name="content"  id="content"  value="<?php echo $content ;?>">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Display picture</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="display_picture" type="file" style="width: 150px;" value="<?php echo $display_picture ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
