                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Phone 1</th>
                                            <th class="border-top-0">Phone 2</th>
                                    ...
                                    ?>
                                       <tr>
                                            ...
                                            <td><a href="edit_contact_details.php?id=<?php echo $row['id']; ?>"><span class="badge bg-primary rounded" style="margin-left:10px;">Edit</span></a></td>
                                            <td><a href="delete_contact.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Contact?');"><span class="badge bg-danger rounded" style="margin-left:10px;">Del</span></a></td> 
