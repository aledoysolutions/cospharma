                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Edit <code>  Distributor</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         ...
                                         <form action="proc_edit_distributors.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Sub Title</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="sub_title" type="text"   value="<?php echo $row['sub_title'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                        <select name="region" class="form-control p-0 border-0" value="<?php echo $row['region'] ;?>">
                                                 <option>Select Region</option>
                                                <option value="Nigeria">Nigeria</option>
                                                <option value="African Countries">African Countries</option>
                                        </select>
                                            <?php echo $row['region'];?>
                                            <!-- <input name="region" type="text"  value="<?php echo $row['region'] ;?>" class="form-control p-0 border-0"> -->
                                        </div>
                                </div>
