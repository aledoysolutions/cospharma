                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        ...
                                        <th class="border-top-0">Id</th>
                                            ...
                                            <th class="border-top-0">Image 1</th>
                                            <th class="border-top-0">Image 2</th>
                                    ...
                                    ?>
                                       <tr>
                                            ...
                                            <td><img src="upload/<?php echo $row['image_1']; ?>" style="width:100px;"></td>
                                            <td><img src="upload/<?php echo $row['image_2']; ?>" style="width:100px;"></td>
                                            <td><a href="edit_products.php?id=<?php echo $row['id']; ?>"><span class="badge bg-primary rounded" style="margin-left:10px;">Edit</span></a></td>

                                            <td><a href="delete_products.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this product?');"><span class="badge bg-danger rounded" style="margin-left:10px;">Del</span></a></td> 
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
