                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Please fill the form below to add a <code>  Product</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         <tr>
                                         <form action="proc_add_products.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="product_name" type="text"  value="<?php echo $product_name ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Image 1</label>
                                        <div class="col-md-12 border-bottom p-0">
