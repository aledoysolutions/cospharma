                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Please fill the form below to edit  <code>  Home Banner</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         <tr>
                                         <form action="proc_edit_home_banner.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0"><img src="upload/<?php echo $row['image']; ?>" style = "width:30px;"></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="image" type="file"  value="<?php echo $image ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
