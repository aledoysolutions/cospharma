            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <!-- ============================================================== -->
                        <li class=" in">
                            <form action="proc-search.php" method="get" role="search"
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <li class="text-center p-20 upgrade-btn" style="list-style-type: none;">
                                <a href="add_distributors.php" class="btn d-grid btn-success text-white">
                                    Add Distributors</a>
                            </li>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_distributors.php?id=<?php echo $row['id']; ?>"><span
                                                        class="badge bg-primary rounded"
                                                        style="margin-left:10px;">Edit</span></a></td>
                                            <td><a href="delete_distributors.php?id=<?php echo $row['id']; ?>"
                                                    onclick="return confirm('Are you sure you want to delete this Distributor?');"><span
                                                        class="badge bg-danger rounded"
                                                        style="margin-left:10px;">Del</span></a></td>
