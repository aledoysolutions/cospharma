                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Please fill the form below to add a <code>  Contact</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         <tr>
                                         <form action="proc_add_contact.php" method="post" enctype="multipart/form-data">
                                ...
                                <!-- <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="product_name" type="text"  style="width: 150px;" value="<?php echo $product_name ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div> -->
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Address</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="address" type="text"   value="<?php echo $address ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Phone 1</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="phone" type="text"  value="<?php echo $phone ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Phone 2</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="phone_2" type="text"  value="<?php echo $phone_2 ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Email</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="email" type="text"  value="<?php echo $email ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
