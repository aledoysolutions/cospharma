                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        ...
                                        <th class="border-top-0">id</th>
                                            ...
                                            <th class="border-top-0">Display Picture</th>
                                    ...
                                    ?>
                                       <tr>
                                            ...
                                            <td><img src="upload/<?php echo $row['display_picture']; ?>" style="width:100px;"></td>
                                            <td><?php echo $row['deadline']; ?></td>
                                            <td><a href="edit_testimonials.php?id=<?php echo $row['id']; ?>"><span class="badge bg-primary rounded" style="margin-left:10px;">Edit</span></a></td>

                                            <td><a href="delete_testimonials.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this testimonial?');"><span class="badge bg-danger rounded" style="margin-left:10px;">Del</span></a></td> 
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
