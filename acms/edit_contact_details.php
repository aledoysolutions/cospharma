            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Contact Detail</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Edit <code>  Contact Detail</code> </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                         ...
                                         <form action="proc_edit_contact_details.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="address" type="text"   value="<?php echo $row['address'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Phone 1</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="phone" type="text"   value="<?php echo $row['phone'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Phone 2</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="phone_2" type="text"   value="<?php echo $row['phone_2'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Email</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="email" type="text"  value="<?php echo $row['email'] ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
