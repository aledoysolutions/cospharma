                                ...
                                <table class="table text-nowrap">
                                    ...
                                    ?>
                                       <tr>
                                            ...
                                            <td><a href="edit_home_banner.php?id=<?php echo $row['id']; ?>"><span class="badge bg-primary rounded" style="margin-left:10px;">Edit</span></a></td>

                                            <td><a href="delete_home_banner.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this home banner?');"><span class="badge bg-danger rounded" style="margin-left:10px;">Del</span></a></td> 
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
